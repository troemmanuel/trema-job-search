-- Trema Job Search - Database Schema V1
...
-- 1. Candidate Profiles (Master CV is the single source of truth)
...
CREATE TABLE IF NOT EXISTS documents (
    ...
    type TEXT NOT NULL, -- CV, COVER_LETTER, APPLICATION_ANSWERS, JOB_DESCRIPTION
...
-- 5. AI Runs (Traceability & Debugging)
CREATE TABLE IF NOT EXISTS ai_runs (
    id UUID PRIMARY KEY DEFAULT gen_random_uuid(),
    application_id UUID REFERENCES applications(id) ON DELETE SET NULL,
    operation TEXT NOT NULL, -- MATCHING, CV_GENERATION, LETTER_GENERATION, ANSWERS_GENERATION
    model TEXT NOT NULL,
    prompt_version TEXT,
    input_data JSONB,
    output_data JSONB,
