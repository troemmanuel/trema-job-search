...
class OpenRouterProvider(BaseLLMProvider):
    """Fournisseur pour OpenRouter via httpx (agrégateur multi-modèles compatible OpenAI)."""

    name: str = "openrouter"
    API_URL: str = "https://openrouter.ai/api/v1/chat/completions"

    def __init__(self, api_key: Optional[str] = None, default_model: Optional[str] = "meta-llama/llama-3.3-70b-instruct"):
        super().__init__(api_key=api_key, default_model=default_model or "meta-llama/llama-3.3-70b-instruct")
    ...
    def generate(
        ...
        if not self.is_configured():
            raise LLMProviderError(self.name, "OPENROUTER_API_KEY non configurée", status_code=401)

        target_model = model or self.default_model or "meta-llama/llama-3.3-70b-instruct"
        ...
        headers = {
            ...
            "HTTP-Referer": "https://trema-job-search.local",
            "X-Title": "Trema Job Search"
        }
