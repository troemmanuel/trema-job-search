...
Usage (depuis apps/api) : uv run python scripts/preview_letter_template.py [dossier_sortie]
"""
import json
import subprocess
import sys
...
profile = json.loads((ROOT / "tests/fixtures/profile_john_doe.json").read_text())
